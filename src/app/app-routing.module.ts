...
const routes: Routes = [
  ...
  {path: 'album/:cosplayer', loadChildren: () => import('./views/pages/album/album.module').then(m => m.AlbumModule)},
  ...
  {path: 'noticia/:slug', loadChildren: () => import('./views/pages/news/news.module').then(m => m.NewsModule)},
  ...
  {path: 'cosplay/:cosplayer/:slug', loadChildren: () => import('./views/pages/photos/photos.module').then(m => m.PhotosModule)},
